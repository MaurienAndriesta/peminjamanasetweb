...
$data = [];
$result = $koneksi->query("SELECT * FROM labftbe ORDER BY no ASC");
...
<nav class="fixed top-0 left-0 right-0 bg-[#D1E5EA] shadow px-4 h-16 z-50 flex items-center gap-4">
  ...
  <div class="relative">
    ...
    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
      <a href="logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-t-lg">Keluar</a>
    </div>
  </div>
</nav>
...
<!-- MAIN CONTENT -->
<main class="pt-20 px-6 pb-20">
  <h2 class="text-xl font-semibold mb-4">Daftar Laboratorium - Fakultas Teknologi dan Bisnis Energi (FTBE)</h2>
    ...
    <table class="w-full border-collapse text-sm" id="dataTable">
      ...
      <tbody class="text-gray-800">
        ...
        <tr class="hover:bg-blue-50">
          <td class="border border-gray-200 px-4 py-3 text-center"><?= $row['no'] ?></td>
