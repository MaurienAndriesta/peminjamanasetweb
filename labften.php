...
$data = [];
$result = $koneksi->query("SELECT * FROM labften ORDER BY no ASC");
...
<main class="pt-20 px-6 pb-20">
  <h2 class="text-xl font-semibold mb-4">Daftar Laboratorium - Fakultas Telematika Energi (FTEN)</h2>
