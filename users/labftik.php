...
// ================= AMBIL DATA LAB FTIK =================
$data = [];
// Pastikan tabelnya benar: labftik
$result = $koneksi->query("SELECT * FROM labftik ORDER BY id ASC");
...
<head>
  ...
  <title>Daftar Laboratorium FTIK</title>
...
<body class="flex flex-col min-h-screen bg-gradient-to-br from-[#D1E5EA] to-white font-sans text-gray-800">
  ...
  <h2 class="text-2xl font-bold text-gray-700 mb-6 border-l-4 border-blue-400 pl-3">
    Daftar Laboratorium Fakultas Teknologi Infrastruktur dan Kewilayahan (FTIK)
  </h2>
